...
save(run2,file=paste(main_path,"/INMCM4/Mu_nonstat_widenorm_run2_RCM.RData",sep=""))
cred.table
save(cred.table,file=paste(main_path,"/INMCM4/Mu_nonstat_widenorm_CI_RCM.RData",sep=""))
mu0=run2$finmat[,1]
amu=run2$finmat[,4]
...
save(muproj_chain,xi_chain,sigma_chain,file=paste(main_path,'/INMCM4/nonstat_param',gg,'.RData',sep=""))}
